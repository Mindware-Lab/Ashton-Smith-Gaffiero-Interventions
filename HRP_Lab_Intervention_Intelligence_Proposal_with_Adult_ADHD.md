...
Which intervention opportunity is most valuable?
Which cognitive-affective mechanism can be changed?
Does that change transfer to meaningful functioning?
```
...
→ test protected and functional transfer
→ deliver the strongest candidates digitally
...
* newly developed ambiguous-scenario materials for adult pain research and interventions;
* recent work on interpretation bias in endometriosis and broader chronic-illness self-management.
...
| Programme asset                            | Contribution                                                                                                                                                   |
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Gaffiero health-psychology programme**   | Cognitive bias, health decision-making, chronic illness, pain, mathematics anxiety, mixed-methods research and clinical-health relevance                       |
...
> **Can pathway intelligence identify a high-value support opportunity, can a mechanism-targeted protocol modify the relevant process, and does that change transfer into everyday functioning?**
...
```text
1. Service-pathway intelligence
...
4. Measurement and psychometric engineering
   How can mechanism, function, risk and improvement be measured defensibly?

5. Digital experience, integration and adoption
   How do users and practitioners access and sustain the support?

6. Research, validation and knowledge mobilisation
   What should be tested, published, protected, licensed or implemented?
```
...
# 3. Proposed programme aims

### Primary aim

To develop and prospectively evaluate a reusable system for identifying, engineering and implementing high-value low-intensity cognitive-affective interventions within constrained health and wellbeing pathways.
...
```text
academic demand increases
→ anxiety or intrusive internal dialogue
→ attentional capture and avoidance
→ procrastination or disrupted preparation
→ impaired performance under evaluation
→ wellbeing or academic-support contact
...
```text
threat-related attentional capture
negative internal dialogue
interpretation of ambiguity
performance monitoring
avoidance and task initiation
working-memory disruption under evaluative pressure
evidence accumulation and premature commitment
```

## Candidate intervention

**Exam Resilience Protocol**

A short digitally delivered programme combining:

* attention-control and attentional-flexibility training;
...
| Wellbeing                 | Anxiety, distress, perceived control and recovery                                  |
| Delayed outcome           | Maintenance at later assessment or examination period                              |

The primary claims would concern functional support and resilience under evaluative stress—not treatment of a diagnosed anxiety disorder or guaranteed improvement in grades.
...
→ pain management programme or self-management advice
→ variable engagement and functional recovery
```
...
```text
pain- and illness-related interpretation bias
threat-sensitive attention
memory for pain-related information
uncertainty and symptom interpretation
fear-related avoidance
activity prediction
context-sensitive evidence accumulation
...
* implementation intentions for valued activity;
...
| Level                          | Example measure                                                    |
| ------------------------------ | ------------------------------------------------------------------ |
| Trained operation              | Interpretation or attention-task performance                       |
| Protected transfer             | New scenarios, bodily sensations, stimulus formats and contexts    |
| Independent cognitive transfer | Separate interpretation, attention or decision task                |
| Functional transfer            | Pain interference, activity engagement, pacing and self-management |
| Health outcome                 | Quality of life, distress and healthcare use                       |
...
→ limited interim support
→ diagnostic assessment
→ medication and/or non-drug support
→ follow-up and functional management
```

The programme would identify:

* where people receive no meaningful support while waiting;
* which functional difficulties generate repeated service contact;
* where low-intensity support is safe, useful and proportionate;
* which users require guided rather than self-directed support;
* which outcomes predict escalation, disengagement or non-response;
* where digital support could reduce inequalities rather than widen them;
* which functions should remain with specialist clinicians and which could be supported through stepped-care pathways.

## Candidate mechanisms

```text
attention variability and lapse recovery
task initiation
working-memory and goal-maintenance failures
prospective-memory difficulties
interruption and context-switch recovery
premature or delayed commitment
emotional capture and frustration
inconsistent planning and self-monitoring
```

## Candidate intervention

**Interim Functional Attention and Executive Support**

This would not diagnose ADHD, replace formal assessment or determine access to medication or specialist services.

It could combine:

* attention-control and adaptive-evidence training;
* task-initiation protocols;
* interruption and context-recovery support;
* relational and prospective-memory scaffolds;
* planning and implementation intentions;
* emotional-interference management;
* weekly functional monitoring;
* escalation and signposting rules where difficulties exceed the scope of low-intensity support.

## ADHD transfer hierarchy

| Evidence level | Example |
| --- | --- |
| **Trained operation** | Improvement on an attention-control or executive-support task |
| **Protected transfer** | New stimulus carriers, timings, distractors and task parameters |
| **Independent cognitive transfer** | Separate sustained-attention, planning or prospective-memory task |
| **Functional transfer** | Task initiation, completion, interruption recovery and everyday organisation |
| **Service outcome** | Engagement while waiting, missed appointments, repeat contacts and escalation |
...
+ measurable education and work outcomes
...
| **Occupational-health and employer partners**                  | Workplace-functioning measures, return-to-work or persistence outcomes and low-intensity support pathways             | Adult ADHD; later workplace resilience                  |

NHS Talking Therapies provides NICE-recommended psychological interventions for anxiety and depression, including where these occur alongside a manageable long-term physical health condition. It may therefore be relevant to later pain-related pathway integration, although the new protocol should not be presented as a replacement for its established therapies. ([NHS England][6])

---

# 9. Why this is a strong fit for Dr Gaffiero

## Proposed role

**Academic co-lead: Health Psychology, Cognitive-Affective Mechanisms and Intervention Development**

Dr Gaffiero would be well positioned to lead or co-lead:
...
* Trident-G and transfer methodology;
* cognitive-task and adaptive-controller design;
* computational models and synthetic experiments;
* cross-wrapper and held-out transfer designs;
* psychometric and behavioural instrumentation;
* digital product architecture;
* protocol versioning and IP strategy.

The collaboration is therefore complementary rather than duplicative:
...
Joint:
functional intervention development + validation + implementation

ADHD expansion:
pathway intelligence + executive-support co-design
...
| **Occupational therapist/executive-function specialist** | Functional assessment, task-initiation support, environmental scaffolding and everyday outcomes | NHS, university, private or occupational-health partner |
| **Clinical or counselling psychologist**          | Intervention safety and integration with established psychological care            | NHS or university service                   |
| **Health-services researcher**                    | Pathway analysis, process mapping and service redesign                             | KCL or NHS partner                          |
...
+ definitive PGfAR programme design
```
...
£200k–£250k / 18–24 months
        ↓
NIHR Programme Grant for Applied Research
approximately £2m–£3.5m / 4–6 years
        ↓
multisite effectiveness, implementation and commercial deployment
```

---

# 12. Funding options table

| Funder/programme                               | Best use                                                                               |                                                       Typical scale | Fit to this proposal                                                                     | Recommendation                                            |
| ---------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------: | ---------------------------------------------------------------------------------------- | --------------------------------------------------------- |
...
RfPB’s current structure permits up to £500,000 for work with relatively immediate patient benefit, up to £300,000 for feasibility or preparatory research, and up to £200,000 for more exploratory work. ([NIHR][9])

HSDR is particularly suited to mixed-methods evaluations of the organisation and quality of health and social care services, including large-scale service transformations and routine service-use data. It would therefore fit the pathway-intelligence component, but not the full intervention-engineering ambition as well as PGfAR. ([NIHR][10])

---

# 13. Programme logic model
...
+ service and health-economic expertise
...
→ test mechanism and functional transfer
→ evaluate adoption and economics
...
Improved access to low-intensity support
Better engagement
Mechanism change
Transfer to independent tasks
Improved functioning
Identification of responders and non-responders
More efficient use of professional support

        ↓

LONG-TERM IMPACT

A reusable platform for locating, engineering
and implementing high-value cognitive-affective and executive-support interventions
across constrained health, education and wellbeing systems
```

---

# 14. Scientific distinctiveness

Most digital intervention programmes begin with an intervention and test average outcomes.

This programme would add three earlier decision layers:

```text
Where should an intervention be placed?
Which mechanism should it target?
What evidence would show that it genuinely transfers?
```
...
Protocols would be banked, revised or retired according to preregistered criteria rather than all pilots being treated as successes.

---

# 15. IP, publication and collaboration structure

Before application, the partners should agree:
...
| Publications                                           | Academic freedom preserved subject to time-limited confidentiality and IP review |
...
[3]: https://www.kcl.ac.uk/student-life/counselling?utm_source=chatgpt.com "Counselling & Mental Health Support"
[4]: https://www.nhs.uk/live-well/pain/how-to-get-nhs-help-for-your-pain/?utm_source=chatgpt.com "How to get NHS help for your pain"
[5]: https://www.gstt.nhs.uk/resources/patient-information/perioperative/pain/input-pain-management-unit.pdf?utm_source=chatgpt.com "INPUT pain management - Overview"
[6]: https://www.england.nhs.uk/mental-health/adults/nhs-talking-therapies/?utm_source=chatgpt.com "NHS Talking Therapies for anxiety and depression"
[7]: https://www.nihr.ac.uk/funding-programmes/programme-grants-for-applied-research/scope-eligibility?utm_source=chatgpt.com "Programme Grants for Applied Research: scope and ..."
[8]: https://www.nihr.ac.uk/funding-programmes/programme-development-grants?utm_source=chatgpt.com "Programme Development Grants (PDG)"
[9]: https://www.nihr.ac.uk/funding-programmes/research-for-patient-benefit?utm_source=chatgpt.com "Research for Patient Benefit (RfPB) Programme"
[10]: https://www.nihr.ac.uk/funding-programmes/health-and-social-care-delivery-research?utm_source=chatgpt.com "Health and Social Care Delivery Research Programme ..."
